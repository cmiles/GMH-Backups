...
using GmhBackups.WeatherFlowTempest.DeviceObservations;
using GmhBackups.WeatherFlowTempest.TempestObservations;
using Serilog;

namespace GmhBackups.WeatherFlowTempest;
...
public static class Observations
{
        ...
        long deviceId, string accessToken, List<DateOnly> utcDays, IProgress<string> progress)
    {
        ...
        foreach (var loopDay in utcDays)
        {
            ...
            if (observationsJson.obs is null)
            {
                Log.ForContext("url", url)
