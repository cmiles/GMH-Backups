namespace GmhBackups.WeatherFlowTempest.TempestObservations;
...
public class TempestObservation
{
    ...
    public static TempestObservation CreateInstance(decimal?[] observation)
    {
        ...
        toReturn.PrecipitationAnalysisTypeTranslation = toReturn.PrecipitationAnalysisType is null ? string.Empty : 
        ...
        toReturn.PrecipitationTypeTranslated = toReturn.PrecipitationType is null ? string.Empty :
