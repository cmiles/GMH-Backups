...
$publishPath = "M:\GmhWorkshopPublications\TucsonElectricPowerBackup"
...
& $msBuild .\GmhWorkshop.TucsonElectricPowerBackup\GmhWorkshop.TucsonElectricPowerBackup.csproj -t:publish -p:PublishProfile=.\GmhWorkshop.TucsonElectricPowerBackup\Properties\PublishProfile\FolderProfile.pubxml -verbosity:minimal
