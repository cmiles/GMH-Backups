...
$publishPath = "M:\GmhBackupsPublications\TucsonElectricPowerBackup"
...
& $msBuild .\GmhBackups.TucsonElectricPowerBackup\GmhBackups.TucsonElectricPowerBackup.csproj -t:publish -p:PublishProfile=.\GmhBackups.TucsonElectricPowerBackup\Properties\PublishProfile\FolderProfile.pubxml -verbosity:minimal
