...
$publishPath = "M:\GmhBackupsPublications\SensorPushBackup"
...
& $msBuild .\GmhBackups.SensorPushBackup\GmhBackups.SensorPushBackup.csproj -t:publish -p:PublishProfile=.\GmhBackups.SensorPushBackup\Properties\PublishProfile\FolderProfile.pubxml -verbosity:minimal
