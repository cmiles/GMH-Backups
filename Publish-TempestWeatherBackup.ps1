...
$publishPath = "M:\GmhWorkshopPublications\TempestWeatherBackup"
...
& $msBuild .\GmhWorkshop.TempestWeatherBackup\GmhWorkshop.TempestWeatherBackup.csproj -t:publish -p:PublishProfile=.\GmhWorkshop.TempestWeatherBackup\Properties\PublishProfile\FolderProfile.pubxml -verbosity:minimal
