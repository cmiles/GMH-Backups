...
$publishPath = "M:\GmhBackupsPublications\TempestWeatherBackup"
...
& $msBuild .\GmhBackups.TempestWeatherBackup\GmhBackups.TempestWeatherBackup.csproj -t:publish -p:PublishProfile=.\GmhBackups.TempestWeatherBackup\Properties\PublishProfile\FolderProfile.pubxml -verbosity:minimal
