...
$publishPath = "M:\GmhWorkshopPublications\VictronRemoteMonitoringBackup"
...
& $msBuild .\GmhWorkshop.VictronRemoteMonitoringBackup\GmhWorkshop.VictronRemoteMonitoringBackup.csproj -t:publish -p:PublishProfile=.\GmhWorkshop.VictronRemoteMonitoringBackup\Properties\PublishProfile\FolderProfile.pubxml -verbosity:minimal
