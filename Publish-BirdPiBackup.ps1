...
$publishPath = "M:\GmhWorkshopPublications\BirdPiBackup"
...
& $msBuild .\GmhWorkshop.BirdPiBackup\GmhWorkshop.BirdPiBackup.csproj -t:publish -p:PublishProfile=.\GmhWorkshop.BirdPiBackup\Properties\PublishProfile\FolderProfile.pubxml -verbosity:minimal
